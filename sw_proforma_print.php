...
left join sw_proformas q on g.`pog_rel_po_id` = q.po_revision_id
left join sw_currency c on q.po_rel_cur_id = c.cur_id
left join sw_clients ci on q.po_rel_cli_id = ci.cli_id

where md5(g.`pog_id`)= '".$_GET['id']."' and g.pog_valid = 1 and q.po_valid =1 and ci.cli_valid =1 order by po_revision desc limit 1   ";
                                    ...
                                    <div class="col-xs-8">
                                    	<div class="row">
                                            ...
                                            <table class="table table-bordered">
                                                <thead>
                                                    <tr>
                                                        <th style="width:25%;text-align:center">Proforma Number</th>
                                                ...
                                                <tbody>
                                                	<tr>
                                                    	<td style="text-align:center"><?php echo $row['po_ref'] ?></td>
                                                    	<td style="text-align:center"> <?php echo date('j/n/Y',$getdateofbase['po_dnt']) ?></td>
                                        ...
                                        <div class="row">
                                            ...
                                            <table class="table table-bordered ">
                                                ...
                                                <tbody>
                                                	<tr>
                                                    	<td style="text-align:center"><?php echo $row['pog_lpo'] ?></td>
                                                    	<td style="text-align:center"><?php echo $row['pog_payment_terms'] ?></td>
            ...
            <td style="text-align:center"><strong style="font-size:22px"><?php echo $row['cli_name'] ?></strong><br>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="pull-left">
                                    <p style="margin:0"><strong>Project: </strong> <?php echo $row['po_proj_name'] ?></p>
                                    <p style="margin:0" ><strong>Subject: </strong> <?php echo $row['po_subj'] ?></p>
                                    <p style="margin:0"><?php echo $row['pog_extra'] ?></p>
                                        </div>
...
?>
                <tr>
                    ...
                    <br><?php echo convert_desc($productrow['pi_desc']); ?></td>
                    ...
                    <td style="text-align:right"><?php echo $row['pog_vat'].'%' ?></td>
                    <td style="text-align:right"><?php echo number_format($itotal*($row['pog_vat']/100),2) ?></td>
                    <td style="text-align:right"><?php echo number_format((($row['pog_vat']/100)+1)*($itotal),2) ?></td>
                </tr>
<?php
$total = $itotal + $total;
  $c++;  }
...
if(trim($before[0]) == '-'){
    ...
    <tr>
		...
		<tr>
            ...
            <td colspan="2"></td>
            <td style="text-align:right" colspan="1">
            <?php echo number_format(($row['pog_vat']/100)*$total,2); ?>
            </td>
            <td style="text-align:right" colspan="1">
            <?php echo number_format((($row['pog_vat']/100)+1)*($total),2) ?>
            </td>
        </tr>
		...
		<tr>
            ...
            <td style="text-align:right" colspan="1">
            <?php echo number_format(round($row['pog_discount'],2),2); ?>
            </td>
            <td colspan="2"></td>
            <td style="text-align:right" colspan="1"><?php echo number_format(round($row['pog_discount'] * ($row['pog_vat']/100) ,2),2); ?></td>
            <td style="text-align:right" colspan="1"><?php echo number_format(round($row['pog_discount'] * (1+($row['pog_vat']/100)) ,2),2); ?></td>
        </tr>
		...
		<tr>
            ...
            <td style="text-align:right" colspan="1">
            <?php echo number_format(($total - round($row['pog_discount'],2)),2); ?>
            </td>
            <td colspan="2"></td>
            <td style="text-align:right" colspan="1">
            <?php echo number_format(($row['pog_vat']/100)*($total - round($row['pog_discount'],2)),2); ?>
            </td>
            <td style="text-align:right" colspan="1">
             <strong style="font-size:17px"><?php echo number_format((($row['pog_vat']/100)+1)*(($total - round($row['pog_discount'],2))),2) ?></strong>
            </td>
        </tr>
...
if(trim($after[0]) == '-'){
    ...
    <tr>
        ...
        <tr>
<td colspan="9"><h5 style="margin-top: 0px;margin-bottom: 0px;" class="text-left"><?php echo $row['cur_name'].' '.strtoupper(convert_number_to_words( $row['pog_extra_price'] + (($row['pog_vat']/100)+1)*(($total - round($row['pog_discount'],2))))  ).' ONLY'; ?></h5></td>
</tr>
