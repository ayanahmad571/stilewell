                    ...
                    <div class="col-lg-12	">
                        ...
                        <div class="panel panel-default"><!-- /primary heading -->
                            ...
                            <div class="panel-heading">
                                <h3 class="panel-title">Deletion Logs</h3>
                            </div>
...
if ($productres->num_rows > 0) {
	...
	while($productrw = $productres->fetch_assoc()) {
		...
		echo '<tr>
	<td>'.$con.'</td>
	<td>'.$productrw['adj_ref_code'].'</td>
	<td>'.date('d - M -Y',$productrw['adj_dnt']).'</td>
	<td>'.$productrw['adj_client'].'</td>
	<td>'.$productrw['adj_val'].'</td>
	</tr>';
				$con++;
	}
