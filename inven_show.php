...
<br>
                <p>Qty: <input required  class="form-control" name="add_showroomproduct_old_qty" type="number" step="0.01"  /></p> 
...
<div class="row">
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input required  name="add_showroomproduct_pr_cost" type="number" step="0.01" class="form-control" placeholder="No Unit"/>
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            <label>Showroom Quantity: </label>
            <input required  name="add_showroomproduct_pr_qty" type="number" step="0.01" class="form-control" placeholder="Added to Showroom"/>
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
