...
<link href="assets/datatables/jquery.dataTables.min.css" rel="stylesheet" type="text/css" />  
 ...
 $totalvalueleft = 0;
 $sql = "SELECT * from sw_prod_types where prty_id not in (14,15,16,24,17,25,10,18,20,22,21,19,23,6,1) ";
 ...
 <h3><?php echo $row['prty_name']; ?></h3>                              <table id="datatable1" class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <?php /*<th colspan="3">Sales Invoice<br> and QTY</th>*/ ?>
                                                    <th style="width:9%">Qty Imported</th>
                                                    <th style="width:9%">Qty Sold</th>
                                                    <th style="width:9%">Qty Left</th>
                                                    <th style="width:9%">Unit</th>
                                                    <th style="width:9%">Unit Cost</th>
                                                    <?php /*<th>Total Value</th>*/?>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            <?php
...
<?php		
	...
	';
#	echo '<td>'.number_format(($productrw['pr_price'] * ($productrw['pr_qty'] - $ttqty)),2).'</td>';
	echo'
					</tr>';
