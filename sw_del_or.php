...
if($getrevision['do_revision'] == 0){	echo'
<button id="getPrintView" data-toggle="modal" data-target="#view-modal" data-id="'.md5($getrevision['do_id']).'" class="btn btn-sm btn-danger">Get Print View</button>
';}
