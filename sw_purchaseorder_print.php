...
left join sw_purchaseorders q on g.`pcog_rel_pco_id` = q.pco_revision_id
left join sw_currency c on q.pco_rel_cur_id = c.cur_id
left join sw_suppliers ci on q.pco_rel_sup_id = ci.sup_id

where md5(g.`pcog_id`)= '".$_GET['id']."' and g.pcog_valid = 1 and q.pco_valid =1 and ci.sup_valid =1  order by pco_revision desc limit 1";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
		...
		$getdateofbase = getdatafromsql($conn, "select * from sw_purchaseorders where pco_id = ".$row['pco_revision_id']." and pco_valid =1");
...
<head>
        ...
        <title><?php echo $row['sup_name'].' - '.$row['pco_ref'] ?></title>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="clearfix">
                                    <div class="pull-left">
                                        <h4 class="text-right"><img width="250px" src="<?php echo $stwl['img'] ?>" alt="StileWell General Trading LLC"></h4>
                                ...
                                <div class="row">
                                    ...
                                    <p class="m-t-10"><?php echo $row['pcog_extra'] ?></p>
                                        ...
                                        <div class="pull-right">
                                            <p><strong>Date: </strong> <?php echo date('j/n/Y',$getdateofbase['pco_dnt']) ?></p>
                                            ...
                                            <p class="m-t-10"><strong>Quote Reference: </strong> <?php echo $row['pcog_lpo'] ?></p>
...
?>
                <tr>
                    <td><?php echo $c; ?></td>
                    <td><?php echo $productrow['pr_name']; ?><br><?php echo convert_desc($productrow['pci_desc']); ?></td>
                    <td><?php echo $qty; ?></td>
...
if($row['pcog_discount'] == 0){
	...
	$discount = round($row['pcog_discount'],2);
