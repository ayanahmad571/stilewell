...
<div class="form-group">
	<label>Code : </label>
	<input name="edit_supplier_code" type="text" class="form-control" value="'.$mrw['sup_code'].'"/>
</div>
...
<div class="form-group">
	<label>Email : </label>
	<input name="edit_supplier_email" type="text" class="form-control" value="'.$mrw['sup_email'].'"/>
</div>
